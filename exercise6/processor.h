...
// no temporal  real    0m41.069s
// 				user    0m41.054s
// 				sys     0m0.007s

//100000ns--------> //real   0m43.951s
				    //user   0m43.883s
                    //sys    0m0.023s

//10000ns--------> //real    0m45.485s
				   //user    0m45.436s
                   //sys     0m0.036s

//1000ns-------->  //real    0m45.952s
				   //user    0m45.945s
                   //sys     0m0.000s

//100ns-------->   //real    0m42.694s
				   //user    0m42.671s
                   //sys     0m0.016s
	...
	file(pathToFile), cycleTime(cycleTime)
{
	...
	//SC_THREAD(processRandom);     /////modification for the third task temporal decoupling
